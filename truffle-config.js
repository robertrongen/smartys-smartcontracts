 ...
 */
 ...
 module.exports = {
    ...
    */
     ...
     // make sure that the test addresses have some rinkeby ether before deploying
     networks: {
     ...
     'rinkebytest': {
       provider: () => new HDWalletProvider("wing tell sting pass clay turkey aunt timber farm rival reason famous", `https://rinkeby.infura.io/v3/`+infuraKey),
